...
test.describe('[TC001] Catawiki Search: Retrieve 2nd lot from search results', () => {
  ...
  test('Search for "train" and retrieve 2nd lot details', { tag: ['@TC-001'] }, async ({ Given, When, Then, And }) => { 
    await Given('I navigate to url "/en"'); 
